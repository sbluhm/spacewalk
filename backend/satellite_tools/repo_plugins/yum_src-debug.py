...
class YumWarnings:
    print "class YumWarnings"
    def __init__(self):
        print "YumWarnings.__init__"
        self.saved_stdout = None
        self.errors = None

    def write(self, s):
        print "YumWarnings.write"
        pass

    def disable(self):
        print "YumWarnings.disable"
        self.saved_stdout = sys.stdout
        sys.stdout = self

    def restore(self):
#        print "YumWarnings.restore" # Crashes. not sure why
...
# pylint: disable=W0221
    print "class YumUpdateMetadata(UpdateMetadata)"
    def add(self, obj, mdtype='updateinfo', all_versions=False):
        print "YumUpdateMetadata.add"
...
class RepoMDNotFound(Exception):
    print "class RepoMDNotFound(Exception)"
    pass


class ContentSource(object):
    print "class ContentSource(object)"
    def __init__(self, url, name, yumsrc_conf=YUMSRC_CONF, org="1", channel_label="",
        ...
        print"ContentSource.__init__"
#        print "__init__(self, url, name, yumsrc_conf=YUMSRC_CONF, org=1, channel_label=, no_mirrors=False, ca_cert_file=None, client_cert_file=None, client_key_file=None)"
#        print type(self), type(url), type(name), type(yumsrc_conf), type(org), type(channel_label), type(no_mirrors), type(ca_cert_file), type(client_cert_file), type(client_key_file)
        self.url = url
        self.name = name
...
#        print dir(self)
#        print type(self.__class__), type(self.__del__), type(self.__delattr__), type(self.__dict__), type(self.__doc__), type(self.__format__), type(self.__getattribute__), type(self.__hash__), type(self.__init__), type(self.__module__), type(self.__new__), type(self.__reduce__), type(self.__reduce_ex__), type(self.__repr__), type(self.__setattr__), type(self.__sizeof__), type(self.__str__), type(self.__subclasshook__), type(self.__weakref__), type(self._authenticate), type(self._expand_comps_type), type(self._expand_package_groups), type(self._filter_packages), type(self._find_comps_type), type(self._get_package_dependencies), type(self._sort_packages), type(self.authtoken), type(self.clear_cache), type(self.configparser), type(self.get_file), type(self.get_groups), type(self.get_metadata_paths), type(self.get_modules), type(self.get_package), type(self.get_updates), type(self.groupsfile), type(self.interrupt_callback), type(self.list_packages), type(self.name), type(self.num_excluded), type(self.num_packages), type(self.number_of_packages), type(self.org), type(self.proxy_addr), type(self.proxy_pass), type(self.proxy_user), type(self.raw_list_packages), type(self.repo), type(self.repomd_up_to_date), type(self.set_download_parameters), type(self.setup_repo), type(self.url), type(self.verify_pkg), type(self.yumbase)

    def __del__(self):
        print "ContentSource.__del__"
    ...
    def interrupt_callback(*args, **kwargs):  # pylint: disable=W0613
        print "ContentSource.interrupt_callback"
        # Just re-raise
        e = sys.exc_info()[1]
        raise e

    def setup_repo(self, repo, no_mirrors, ca_cert_file, client_cert_file, client_key_file):
        print "ContentSource.setup_repo"
#        print "ContentSource.setup_repo(self, repo, no_mirrors, ca_cert_file, client_cert_file, client_key_file)"
#        print type(self), type(repo), type(no_mirrors), type(ca_cert_file), type(client_cert_file), type(client_key_file)
        ...
        repo.setup(0)
#        print dir(self)
#        print type(self.__class__), type(self.__del__), type(self.__delattr__), type(self.__dict__), type(self.__doc__), type(self.__format__), type(self.__getattribute__), type(self.__hash__), type(self.__init__), type(self.__module__), type(self.__new__), type(self.__reduce__), type(self.__reduce_ex__), type(self.__repr__), type(self.__setattr__), type(self.__sizeof__), type(self.__str__), type(self.__subclasshook__), type(self.__weakref__), type(self._authenticate), type(self._expand_comps_type), type(self._expand_package_groups), type(self._filter_packages), type(self._find_comps_type), type(self._get_package_dependencies), type(self._sort_packages), type(self.authtoken), type(self.clear_cache), type(self.configparser), type(self.get_file), type(self.get_groups), type(self.get_metadata_paths), type(self.get_modules), type(self.get_package), type(self.get_updates), type(self.interrupt_callback), type(self.list_packages), type(self.name), type(self.number_of_packages), type(self.org), type(self.proxy_addr), type(self.proxy_pass), type(self.proxy_user), type(self.raw_list_packages), type(self.repo), type(self.repomd_up_to_date), type(self.set_download_parameters), type(self.setup_repo), type(self.url), type(self.verify_pkg), type(self.yumbase)

    def number_of_packages(self):
        print "ContentSource.number_of_packages"
    ...
    def raw_list_packages(self, filters=None):
        print "ContentSource.raw_list_packages"
#        print "ContentSource.raw_list_packages(self, filters=None)"
#        print type(self), type(filters)
...
#        print dir(self)
#        print type(rawpkglist)
        return rawpkglist

    def list_packages(self, filters, latest):
        print "ContentSource.list_packages"
        """ list packages"""
        self.repo.getPackageSack().populate(self.repo, 'metadata', None, 0)
    ...
    def _sort_packages(pkg1 ,pkg2):
        print "ContentSource._sort_packages"
    ...
    def _find_comps_type(comps_type, environments, groups, name):
        print "ContentSource._find_comps_type"
    ...
    def _expand_comps_type(self, comps_type, environments, groups, filters):
        print "ContentSource._expand_comps_type"
        new_filters = []
        # Rebuild filter list
    ...
    def _expand_package_groups(self, filters):
        print "ContentSource._expand_package_groups"
    ...
    def _filter_packages(packages, filters):
        print "ContentSource._filter_packages"
    ...
    def _get_package_dependencies(self, sack, packages):
        print "ContentSource._get_package_dependencies"
    ...
    def get_package(self, package, metadata_only=False):
        print "ContentSource.get_package"
        """ get package """
    ...
    def verify_pkg(_fo, pkg, _fail):
        print "ContentSource.verify_pkg"
        return pkg.verifyLocalPkg()

    def clear_cache(self, directory=None, keep_repomd=False):
        print "ContentSource.clear_cache"
    ...
    def get_updates(self):
        print "ContentSource.get_updates"
    ...
    def get_groups(self):
        print "ContentSource.get_groups"
        try:
    ...
    def get_modules(self):
        print "ContentSource.get_modules"
        try:
    ...
    def repomd_up_to_date(self):
        print "ContentSource.repomd_up_to_date"
    ...
    def set_download_parameters(self, params, relative_path, target_file, checksum_type=None, checksum_value=None,
                                bytes_range=None):
        print "ContentSource.set_download_paramters"
    ...
    def get_metadata_paths(self):
        print "ContentSource.get_metadata_paths"
        def get_location(data_item):
            print "ContentSource.get_metadata_paths.get_location"
        ...
        def get_checksum(data_item):
            print "ContentSource.get_metadata_paths.get_checksum"
            for sub_item in data_item:
